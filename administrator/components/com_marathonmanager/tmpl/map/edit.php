...
<form action="<?php echo $action; ?>" method="post" name="adminForm" id="item-form" class="form-validate form-vertical">
    ...
    <div class="main-card">
        ...
        <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'description', Text::_('COM_MARATHONMANAGER_DESCRIPTION_TAB_TITLE')); ?>
        <div class="row">
            <div class="col-lg-9">
                <?php echo $this->getForm()->renderField('description'); ?>
            </div>
            <div class="col-lg-3">
                <?php echo $this->getForm()->renderField('count_of_free_maps'); ?>
                <?php echo $this->getForm()->renderField('additional_maps_possible'); ?>
                <?php echo $this->getForm()->renderField('price_per_map'); ?>
                <?php echo $this->getForm()->renderField('max_maps'); ?>
            </div>
        </div>
