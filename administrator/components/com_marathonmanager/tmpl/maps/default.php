...
$route = Route::_('index.php?option=com_marathonmanager&view=maps');
$canChange = true;
...
if ($saveOrder && !empty($this->items)) {
    $saveOrderingUrl = 'index.php?option=com_marathonmanager&task=maps.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
                        ...
                        foreach ($this->items as $i => $item):
                            ...
                            <tr class="row<?php echo $i % 2; ?>" data-draggable-group="listItems">
                                ...
                                <th scope="row" class="has-context">
                                    <a class="hasTooltip"
                                       href="<?php echo Route::_('index.php?option=com_marathonmanager&task=map.edit&id=' . (int)$item->id); ?>"
