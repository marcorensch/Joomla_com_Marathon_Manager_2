...
$title = 'Import';
$formActionUrl = "index.php?option=com_marathonmanager&view=results&layout={$layout}{$tmpl}";

?>

<form action="<?php echo Route::_($formActionUrl); ?>" method="post" name="adminForm" id="adminForm" class="form-vertical">
