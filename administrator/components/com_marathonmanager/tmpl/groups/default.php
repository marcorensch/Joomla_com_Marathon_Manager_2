...
$route = Route::_('index.php?option=com_marathonmanager&view=groups');
$canChange = true;
...
if ($saveOrder && !empty($this->items)) {
    $saveOrderingUrl = 'index.php?option=com_marathonmanager&task=groups.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
                    ...
                    <table class="table" id="itemsList">
                        ...
                        <tr>
                            ...
                            <th scope="col" style="width: 1%" class="d-none d-md-table-cell text-center">
                                <?php echo HTMLHelper::_('searchtools.sort', 'COM_MARATHONMANAGER_TABLE_TABLEHEAD_GROUPID_TITLE', 'a.group_id', $listDirn, $listOrder); ?>
                            </th>
                            <th scope="col" style="width: 1%" class="d-none d-md-table-cell text-center">
                                <?php echo HTMLHelper::_('searchtools.sort', 'COM_MARATHONMANAGER_TABLE_TABLEHEAD_SHORTCODE_TITLE', 'a.shortcode', $listDirn, $listOrder); ?>
                            </th>
                            <th scope="col" style="min-width: 150px" class="d-none d-md-table-cell">
                                <?php echo HTMLHelper::_('searchtools.sort', 'COM_MARATHONMANAGER_TABLE_TABLEHEAD_TITLE', 'a.title', $listDirn, $listOrder); ?>
                            </th>
                            <th scope="col" style="width: 1%" class="d-none d-md-table-cell">
                                <?php echo HTMLHelper::_('searchtools.sort', 'COM_MARATHONMANAGER_TABLE_TABLEHEAD_MAX_PARTICIPANTS_TITLE', 'a.max_participants', $listDirn, $listOrder); ?>
                            </th>
