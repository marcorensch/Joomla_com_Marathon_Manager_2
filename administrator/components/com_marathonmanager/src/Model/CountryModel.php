...
class CountryModel extends \Joomla\CMS\MVC\Model\AdminModel
{

	public $typeAlias = 'com_marathonmanager.country';
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_marathonmanager.edit.country.data', []);
		...
		if (empty($data)) {
			...
			if ($this->getState('event.id') == 0) {
				$data->set('catid', $app->input->get('catid', $app->getUserState('com_marathonmanager.countries.filter.category_id'), 'int'));
			}
		}
