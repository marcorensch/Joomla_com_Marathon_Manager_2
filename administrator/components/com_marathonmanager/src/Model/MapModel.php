...
class MapModel extends \Joomla\CMS\MVC\Model\AdminModel
{

	public $typeAlias = 'com_marathonmanager.map';
	...
	{
		$form = $this->loadForm($this->typeAlias, 'map', ['control' => 'jform', 'load_data' => $loadData]);
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_marathonmanager.edit.map.data', []);
