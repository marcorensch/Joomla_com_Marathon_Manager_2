...
class ArrivaloptionModel extends \Joomla\CMS\MVC\Model\AdminModel
{
	...
	{
		$form = $this->loadForm($this->typeAlias, 'arrivaloption', ['control' => 'jform', 'load_data' => $loadData]);
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_marathonmanager.edit.arrivaloption.data', []);
