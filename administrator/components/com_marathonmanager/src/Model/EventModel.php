...
class EventModel extends \Joomla\CMS\MVC\Model\AdminModel
{
    ...
    public function save($data)
    {
        ...
        $defaultNullFields = ['publish_up', 'publish_down', 'registration_start_date', 'registration_end_date', 'earlybird_end_date', 'event_date', 'earlybird_fee','price_per_map', 'lastinfos_newsletter_list_id'];
