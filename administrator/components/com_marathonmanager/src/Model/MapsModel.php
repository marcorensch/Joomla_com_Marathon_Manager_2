...
/**
 * Methods supporting a list of maps records.
 *
 * @since  1.0
 */
...
class MapsModel extends ListModel
{
	...
	protected function getListQuery(): QueryInterface|DatabaseQuery
	{
		...
		$query->select(
			$db->quoteName(['a.id','a.title','a.alias', 'a.ordering', 'a.access', 'a.published'])
		);
		// From the table
		$query->from($db->quoteName('#__com_marathonmanager_maps','a'));
